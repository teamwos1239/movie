...
/**
 * Servlet implementation class SaveCityFilminfoServlet
 */
public class SaveCityFilminfoServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SaveCityFilminfoServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.sendRedirect("FilmInfoMovieServlet?mno="+mno);
	}
