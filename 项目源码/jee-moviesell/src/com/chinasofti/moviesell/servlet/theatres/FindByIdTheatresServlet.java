...
/**
 * Servlet implementation class FindByIdTheatresServlet
 */
public class FindByIdTheatresServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FindByIdTheatresServlet() {
        super();
...
//		lstSetCities
		...
		List<Cities> lstSetCities=citiesBiz.findAll();
		
		HttpSession session=request.getSession();
		session.setAttribute("lstSetCities", lstSetCities);
		
		
		request.setAttribute("findtheatre", theatre);
