...
<html>
<%@page import="com.chinasoft.moviesell.utils.dates.*"%>
<%@ page session="false"%>

<body bgcolor="white">
	<jsp:useBean id='clock' scope='page' class='com.chinasoft.moviesell.utils.dates.JspCalendar'
		type="com.chinasoft.moviesell.utils.dates.JspCalendar" />
