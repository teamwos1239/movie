		...
		<div id="" class="main_main">
			<div id="" class="main_left">
				...
				<dl >
					...
					<dd id="dd1" class="ddon" style="">
						<div><a href="#">新用户注册</a></div>
						<div ><a href="/jee-moviesell/jsp/helper/helper_login.jsp" class="on">用户登录</a></div>
			...
			<div id="" class="main_right">
				...
				<div id="" class="right_tit">
					用户登录<br/> 
				</div>
				
				<div id="" class="right_txt">
					<p>1.	您可使用注册时填写的邮箱地址、手机号登陆万达电影网。</p>
					<p>2.	新版网站支持随机密码登录功能。</p>
					<p style="color:#DD4B39;">注：系统根据你所填写的用户名（邮箱地址、手机号）以邮件或短信方式想您发放随即登录密码。</p>
					<p>3.	当您的万达电影网与第三方网站帐号绑定后，可用第三方网站帐号登陆万达电影网。</p>
				</div>
				<div id="" class="right_img">
					<img src="/jee-moviesell/pic/hepler/login.jpg" width="558" height="251" title="用户登录">
				</div>
