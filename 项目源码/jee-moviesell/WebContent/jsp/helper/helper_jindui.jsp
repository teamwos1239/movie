		...
		<div id="" class="main_main">
			<div id="" class="main_left">
			  ...
			  <dt onClick="menuOnclick('dd4');">
					...
					<dd id="dd4" class="ddon" style="">
						<div><a href="#">会员服务介绍</a></div>
						<div><a class="on" href="/jee-moviesell/jsp/helper/helper_jindui.jsp">积分兑换</a></div>
						<div><a href="#">常见问题</a></div>
					</dd>
				</dl>
				</div>
			...
			<div id="" class="main_right">
				...
				<div id="" class="right_tit">积分兑换<br/> 
				</div>
				
				<div id="" class="right_txt">
					<p>万达电影会员可使用积分兑换礼品，影票。</p>
					<p></p>
					<p></p>
					<p>1.兑换礼品</p>
				</div>
				<div id="" class="right_txt_x">
					进入积分兑换页面，选择礼品，点击"立刻兑换"确认收货人信息无误后，点击提交即可完成兑换。
				</div>
				<div id="" class="right_img">
					<img src="/jee-moviesell/pic/hepler/jf_convert.jpg" id="jf_convert" title="积分兑换">
				</div>
				...
				<div id="" class="right_txt_x">
					<p>在电影排期页面选择支持积分兑换的场次并购买，在订单确认页面使用积分兑换功能即可兑换影票。</p>
					<p style="color:#DD4B39;">注：积分只可兑换影票，需兑换全部座位。</p>
				</div>
