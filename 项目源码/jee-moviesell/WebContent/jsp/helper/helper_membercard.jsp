		...
		<div id="" class="main_main">
			<div id="" class="main_left">
			  ...
			  <dt onClick="menuOnclick('dd3');">
					...
					<dd id="dd3" class="ddon" style="">
						<div><a class="on" href="/jee-moviesell/jsp/helper/helper_membercard.jsp">会员(储蓄)卡</a></div>
						<div><a href="#">礼券</a></div>
			...
			<div id="" class="main_right">
				...
				<div id="" class="right_tit">会员(储蓄)卡<br/> 
				</div>
				...
				<div id="" class="right_txt_x">
					<p style="width: 581px;">会员（储值）卡是万达院线发行的功能齐全的会员实物卡，用户使用该卡购票可享受折扣，用户可通过万达电影网享受储值卡购票、充值、修改密码服务。</p>
				...
				<div id="" class="right_txt_x">
					<p>• 会员（储值）卡余额查询、充值、修改密码、绑定</p>
					<p style="width: 585px;">进入用户中心，在我的会员卡页面输入卡号、密码即可查询卡余额、进行充值、改密码操作；还可将卡与网站账户绑定。绑定后无需再次输入卡号、密码即可相应操作。</p>
				</div>
				 <div id="" class="right_img">
					<p><img src="/jee-moviesell/pic/hepler/member_card.jpg" id="buy_step1_1"  title="积分兑换"></p>
					<p>&nbsp;</p>
					<p>&nbsp;</p>
					<p><img src="/jee-moviesell/pic/hepler/member_card1.jpg" id="buy_step1_1"  title="积分兑换"></p>
    </div>
				...
				<div id="" class="right_txt_x">
					<p>在订单支付页面，选择会员（储值）卡进行支付，输入卡号、密码即可。系统会自动计算出是否享受折扣，以及折扣信息。
</p>
					<p style="color:#DD4B39;">注：如会员卡已与网站帐号绑定则无需输入卡号。只需输入密码即可完成支付，还可使用短信密码支付功能。</p>
				</div>
				 <div id="" class="right_img"><img src="/jee-moviesell/pic/hepler/member_card2.jpg" id="buy_step2" title="积分兑换"></div>
