...
<c:if test="${requestScope.orderItemPage==null }">

	<script type="text/javascript">
			location = "/jee-moviesell/PageOrderItemServlet?currentPage=" + 1;
	</script>
</c:if>
...
<script type="text/javascript">
	function gotoPage(page) {
		var url = "/jee-moviesell/PageOrderItemServlet?currentPage=" + page;
		location = url;
				...
				<div id="main_main" class="main_main">
					<table >
					  <tr class="tab_tit">
					   ...
					   <c:if test="${requestScope.orderItemPage.list!=null}">
						  <c:forEach items="${requestScope.orderItemPage.list}" var="orderItem"  varStatus="i">
							 <tr class="tab_main">
						    <td>${i.count }</td>
					  ...
					  <c:if test="${empty requestScope.orderItemPage.list}">
							  <tr class="tab_main">
					...
					<div class="page_to">
						...
						onchange="javascript:gotoPage(this.value);">
							...
							<c:forEach var="i" begin="1"
								end="${requestScope.orderItemPage.totalPage }">
								<c:if test="${i!=requestScope.orderItemPage.currentPage}">
