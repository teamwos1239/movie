...
<link rel="stylesheet" type="text/css"
	href="/jee-moviesell/css/login_footer.css" />
<link rel="stylesheet" type="text/css"
	href="/jee-moviesell/css/allstyle.css" />
<link rel="stylesheet" type="text/css"
	href="/jee-moviesell/css/users/users.css" />
<link rel="stylesheet" type="text/css"
	href="/jee-moviesell/css/footer_linkarea.css" />
<script type="text/javascript" src="/jee-moviesell/js/index/top_nav.js"></script>
<script type="text/javascript"
	src="/jee-moviesell/js/index/footer_linkarea.js"></script>
<link rel="stylesheet" type="text/css"
	href="/jee-moviesell/css/gotop.css" />

<script type="text/javascript"
	src="/jee-moviesell/js/users/users_menu.js"></script>
...
<body >
	...
	<div id="top" class="top">
		<div id="top_1" class="top_1">
			...
			<div id="top_link" class="top_link">
				...
				<span id="link1" class="link"><a href="/jee-moviesell/jsp/helper/helper_howtobuy.jsp"
					style="color: #999; text-decoration: none;">帮助中心</a></span> <span
					id="link-1" class="link">&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;</span>
				<span id="link2" class="link"><a href="/jee-moviesell/jsp/users/user_order.jsp"
					style="color: #999; text-decoration: none;">我的订单</a></span> <span
					id="link-2" class="link">&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;</span>
				<c:if test="${sessionScope.logineduser==null||empty sessionScope.logineduser}">
	...
	<div id="top_nav" class="top_nav">
		...
		<ul id="nav_ul2" class="nav_ul">
			...
			<li><a><img src="/jee-moviesell/pic/index/IMAX.png"
					width="130" height="54" class=" " id=" " alt="IMAX"
					onClick="javascript:void(0);" style="cursor: pointer;" /> </a></li>
			<li style="width: 34px;">&nbsp;</li>
			<li><a><img src="/jee-moviesell/pic/index/hdcx-btn.png"
					width="174" height="43" class=" " id=" "
					onClick="javascript:void(0);" style="cursor: pointer;" /></a></li>
		</ul>
	</div>
	<!--  网页头部结束 -->
	...
	<div id="content" class="content">
		...
		<div id="content_nav" class="content_nav">
			<span id="" class="nav_off"> 您当前的位置：<a href="/jee-moviesell/jsp/index.jsp">首页</a>&#62;<a
				href="#">用户中心首页</a>&#62;
			</span> <span id="" class="nav_on"> 用户中心 </span>
		</div>
			...
			<div id="" class="main_main">
				<div id="" class="main_left">
					<div id="" class="user_img">
						<img src="/jee-moviesell/pic/user/users.jpeg" alt="用户头像 "
							title="用户头像 " />
						<!-- 用户头像 -->
					</div>
					...
					<dl class="user_menu" id="user_menu">
						...
						<dd class="">
							<a href="/jee-moviesell/jsp/users/user_order.jsp">我的订单</a>
						</dd>
						<dd class="">
							<a href="#">我的团购</a>
						</dd>
						...
						<dd class="">
							<a href="/jee-moviesell/jsp/users/users_set.jsp">账号设置</a>
						</dd>
						<dd class="">
							<a href="#">我的消息</a>
						</dd>
				...
				<div id="" class="main_right">
					...
					<div id="" class="main_tit">
						欢迎您！${sessionScope.logineduser.uname} &nbsp;&nbsp;&nbsp;<a href="" charset=""
							class="mod">修改</a>
					</div>
					<div id="" class="main_main">
						<p>
							您的邮箱号： ${sessionScope.logineduser.uemail} <a href="" charset="" class="mod">修改</a>
						  
							 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							 <span	id="" class="warning">待支付订单：无</span>
						</p>
						<p></p>
						<br>
						<p>
							您的会员级别：${sessionScope.logineduser.ulevel  }星会员【只需再消费￥500元 ，即可升级到<a href="" charset="" class="mod">二星会员</a>】
						</p>
						<p>会员级别有效期：
							 <c:if test="${sessionScope.logineduser.uleveltime!=9999 }">
							 	${sessionScope.logineduser.uleveltime }
							</c:if>
							 <c:if test="${sessionScope.logineduser.uleveltime==9999 }">
								终身有效
							</c:if>
						</p>
						<p>您的兑换积分：${sessionScope.logineduser.uintegral }</p>
	...
	<div id="footer_linkarea" class="footer_linkarea">
		<table width="995" id="footer_tab" class="footer_tab">
			<tr>
				...
				<td><img src="/jee-moviesell/pic/footer/footer_2.png"
					title="在线客服" width="188" height="42" style="cursor: pointer;"
			...
			<tr>
				<td><img src="/jee-moviesell/pic/footer/footer_5.png"
					title="兑换码使用帮助" width="187" height="44" style="cursor: pointer;"
					onClick="javascript:void(0);" /></td>
				<td><img src="/jee-moviesell/pic/footer/footer_6.png"
					title="IMAX" width="196" height="41" style="cursor: pointer;"
					onClick="javascript:void(0);" /></td>
			...
			<tr>
				<td colspan="2"><img
					src="/jee-moviesell/pic/footer/footer_7.png" title="购票流程"
					width="126" height="48" style="cursor: pointer;"
