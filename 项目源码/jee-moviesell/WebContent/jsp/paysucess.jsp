...
<link rel="stylesheet" type="text/css" href="/jee-moviesell/css/paysuccess_main.css" />
...
<body >
	...
	<div id="content" class="content">
		...
		<div id="content_nav" class="content_nav">
			...
			<a id="" href="/jee-moviesell/jsp/index.jsp" class="nav_off">&#62;&#62; 返回首页，继续浏览~ </a> 
			<a id="" href="/jee-moviesell/jsp/users/user_order.jsp" class="nav_off">&#62;&#62; 进入 订单中心 查看订单</a> 
		</div>
		<br /> <br />
		<div id="content_main" class="content_main">
			 
			<div id="" class="main_tip">
				<p>
					已购买成功~
				</p>
				<p>
					电影兑换码已发到您的邮箱[<span style="color: #888;font-size: 21px;">${sessionScope.logineduser.uemail }</span>]里  请注意查收~
				</p>
				<p>
					赶紧快和您的小伙伴们一起去观看电影吧~
				</p>
