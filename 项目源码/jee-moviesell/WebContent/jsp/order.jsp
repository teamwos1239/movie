	...
	<div id="content" class="content">
		...
		<div id="content_nav" class="content_nav">
			<a id="" href="javascript:location='/jee-moviesell/FindShowmoiveItemByCondtionServlet?cno=${sessionScope.selectedCity}';"  class="nav_off">① 选择影片场次 &#62;&#62;</a>
		 	<a id="" href="javascript:location='/jee-moviesell/FindShowmoiveItemByIdServlet?sno=${requestScope.orderShowmoiveItem.sno}';" class="nav_off">② 选择座位、卖品 &#62;&#62;</a> 
		 	<span id="" class="nav_on">③ 确认订单并支付 &#62;&#62;</span> 
		 	<span id="#"	class="nav_off">④ 购票成功</span>
		</div>
		<br /> <br />
		<div id="content_main" class="content_main">
			<br /> <br />
			<div id="main_tit" class="main_tit">确认订单并支付</div>
			<br /> <br /> <br />
			<table>
			<tr>
			...
			<div id="" class="" style="color: red;font-size:12px;">友情提示：只有在您支付成功之后，您的邮箱才会收到相应的电影票兑换码</div>
			<div id="" class="main_submitbtn">
			  	<button onclick="javascript:location='/jee-moviesell/AddOrderServlet'">确认订单 支付</button>
			</div>
